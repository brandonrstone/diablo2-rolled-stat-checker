...
const Runeword: React.FC = (runeward: RunewordType): JSX.Element => (
  <div className='runeword-container'>
    ...
    <div className='runeword-runes'>
      ...
      {runeward.Rune2.substring(0, 1)}<span style={{ fontSize: 18 }}>{runeward.Rune2.substring(1, runeward.Rune1.length)}</span>
      {runeward.Rune3 != null && runeward.Rune3.substring(0, 1)}{runeward.Rune3 != null && <span style={{ fontSize: 18 }}>{runeward.Rune3.substring(1, runeward.Rune1.length)}</span>}
      {runeward.Rune4 != null && runeward.Rune4.substring(0, 1)}{runeward.Rune4 != null && <span style={{ fontSize: 18 }}>{runeward.Rune4.substring(1, runeward.Rune1.length)}</span>}
